...
require (
	...
	github.com/rhobs/rhobs-synthetics-agent v0.0.0-20251024140228-9a1772a2c7e1 // indirect
	github.com/rhobs/rhobs-synthetics-api v0.0.0-20251023141806-7692652c4078 // indirect
